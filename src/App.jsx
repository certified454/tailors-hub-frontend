    ...
    <div className="main-container">
      ...
      <div className='slide-show'>
        ...
        <p className="contest-description">
          Join our exciting contest to showcase your creativity and design skills! Submit your unique outfit designs for a chance to win amazing prizes and be featured in our exclusive collection.
        </p>
      </div>
